...
export function ActivitySection() {
  const activities = [
    "Computer Vision для медицинской диагностики",
    "NLP чат-бот для студентов", 
    "Рекомендательная система для онлайн-обучения",
    "Подготовка к Kaggle competitions",
    "Участие в AI-хакатонах",
    "Разборы статей с ArXiv"
  ];
