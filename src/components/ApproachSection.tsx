...
export function ApproachSection() {
  const principles = [
    ...
    },
    {
      ...
      description: "Мы не верим в легкие пути. Настоящий драйв и результат рождаются в часах, потраченных на отладку кода, в сложной математике, которая наконец поддалась. Мы знаем, что будет трудно, и именно поэтому машинным обучением занимается не каждый. Каждое наше усилие сегодня — это шаг, который отделяет нас от всех остальных."
    },
    {
